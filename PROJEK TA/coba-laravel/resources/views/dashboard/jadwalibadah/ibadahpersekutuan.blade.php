...
<div
        ...
        <h1 class="h2">Ibadah Persekutuan Doa Pemuda</h1>
    </div>

    <div class="col-lg-8">
        <form method="post" action="/dashboard/jadwalibadah/ipersedoapemuda" class="mb-5">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="-" class="form-control @error('slug') is-invalid @enderror" name="alamat" required >
              @error('slug')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
