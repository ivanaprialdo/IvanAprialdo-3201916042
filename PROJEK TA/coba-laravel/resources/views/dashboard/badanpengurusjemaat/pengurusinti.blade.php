    ...
    <div class="col-lg-8">
        ...
        <form method="post" action="/dashboard/badanpengurusjemaat/pengurusinti" class="mb-5">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('title') is-invalid @enderror"  name="wakilketuasatu" required >
              @error('title')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
        ...
        <form method="post" action="/dashboard/badanpengurusjemaat/pengurusinti" class="mb-5">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('title') is-invalid @enderror"  name="wakilketuadua" required >
              @error('title')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
        ...
        <form method="post" action="/dashboard/badanpengurusjemaat/pengurusinti" class="mb-5">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('title') is-invalid @enderror"  name="wakilsekretaris" required >
              @error('title')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
        ...
        <form method="post" action="/dashboard/badanpengurusjemaat/pengurusinti" class="mb-5">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('title') is-invalid @enderror"  name="wakilbendehara" required >
              @error('title')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
        ...
        <form method="post" action="/dashboard/badanpengurusjemaat/pengurusinti" class="mb-5">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('title') is-invalid @enderror"  name="staftatausaha" required >
              @error('title')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
